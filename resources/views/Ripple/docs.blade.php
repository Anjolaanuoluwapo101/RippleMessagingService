      ...
      <div class="w3-content">
        ...
        <div class="w3-container">
          ...
          <div class="w3-content">
            ...
            <ul>
              <li>Ensure you're a registered rippler and person making the comment is also a registered rippler(simply refer them to the site to register if not when a guest tries to make a comment/reply he/she will automatically be redirected from your site to the registration page) — <a href="{{route('register')}}"> Register</a></li>
              <li>Copy the URL found under the `Send Comment/Reply Link`column for the corresponding URL(post/content).Check the Registered URLs table for this in your the dashboard
            ...
            <ul>
              ...
              <li>An input tag called <pre>'ripple_reference_id'</pre> which should contain the id of the comment the post form is replying to.</li>
              <li>An input tag called <pre>'rippler_reference_id'</pre> which should contain the id of the person who made the comment being replied </li>
              <li>A message body with the html attribute <b>name</b> <pre> 'ripple_body' </pre></li>
              <li>For media files,the inputs should all have an html attribute <b>name</b> of <pre> 'files[]' </pre> </li>
            </ul>
          </div>
